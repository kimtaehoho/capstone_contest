...
def point_store():
    ...
    coffee_data = [
        {"id": "starbucks1", "name": "스타벅스 커피 1", "point_cost": 300, "image_url": "coffee_gift/starbucks1.jpg"},
        {"id": "starbucks2", "name": "스타벅스 커피 2", "point_cost": 350, "image_url": "coffee_gift/starbucks2.jpg"},
        {"id": "starbucks3", "name": "스타벅스 커피 3", "point_cost": 400, "image_url": "coffee_gift/starbucks3.jpg"},
        {"id": "paiks1", "name": "빽다방 커피 1", "point_cost": 200, "image_url": "coffee_gift/paiks1.jpg"},
        {"id": "paiks2", "name": "빽다방 커피 2", "point_cost": 300, "image_url": "coffee_gift/paiks2.jpg"},
        {"id": "paiks3", "name": "빽다방 커피 3", "point_cost": 350, "image_url": "coffee_gift/paiks3.jpg"},
        {"id": "twosome1", "name": "투썸플레이스 커피 1", "point_cost": 350, "image_url": "coffee_gift/twosome1.jpg"},
        {"id": "twosome2", "name": "투썸플레이스 커피 2", "point_cost": 500, "image_url": "coffee_gift/twosome2.jpg"},
        {"id": "twosome3", "name": "투썸플레이스 커피 3", "point_cost": 500, "image_url": "coffee_gift/twosome3.jpg"},
    ]
...
def buy_coffee():
    ...
    coffee_data = {
        "starbucks1": {"name": "스타벅스 커피 1", "point_cost": 300},
        "starbucks2": {"name": "스타벅스 커피 2", "point_cost": 350},
        "starbucks3": {"name": "스타벅스 커피 3", "point_cost": 400},
        "paiks1": {"name": "빽다방 커피 1", "point_cost": 200},
        "paiks2": {"name": "빽다방 커피 2", "point_cost": 300},
        "paiks3": {"name": "빽다방 커피 3", "point_cost": 350},
        "twosome1": {"name": "투썸플레이스 커피 1", "point_cost": 350},
        "twosome2": {"name": "투썸플레이스 커피 2", "point_cost": 500},
        "twosome3": {"name": "투썸플레이스 커피 3", "point_cost": 500},
    }
...
@login_required
def update_machine():
    point_increase = int(request.form.get('point_increase', 0))
